...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_windows_SOURCE_PREFIX /home/robot/catkin_ws/src/rosserial/rosserial_windows)
  set(rosserial_windows_DEVEL_PREFIX /home/robot/catkin_ws/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_windows' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/catkin_ws/src/rosserial/rosserial_windows/${idir}'.  ${_report}")
    endif()
