...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_mbed_SOURCE_PREFIX /home/robot/catkin_ws/src/rosserial/rosserial_mbed)
  set(rosserial_mbed_DEVEL_PREFIX /home/robot/catkin_ws/devel)
...
if(NOT "/home/robot/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_mbed' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/catkin_ws/src/rosserial/rosserial_mbed/${idir}'.  ${_report}")
    endif()
